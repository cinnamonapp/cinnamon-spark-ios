...
- (void)generateView {
    ...
    [_imageView setFrame:CGRectMake(horizontalCenter - (self.iconWidth / 2), CGRectGetMaxY(_subTextLabel.frame) + self.underBodyPadding, self.iconWidth, self.iconHeight)];
